<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
    ...
    <?php if (hakOwner() == TRUE OR hakAdmin() == TRUE OR hakSales() == TRUE OR hakPurchasing() == TRUE OR hakAccounting() == TRUE): ?>
        <li class="nav-item">
    ...
    <?php endif; ?>
    <?php if (hakOwner() == TRUE OR hakAdmin() == TRUE OR hakAccounting() == TRUE): ?>
        <li class="nav-item">
