        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <?php echo form_open(base_url('gudang/mutasi/set_trans_simpan.php'), 'autocomplete="off"') ?>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group <?php echo (!empty($psnGagal['pelanggan']) ? 'text-danger' : '') ?>">
                                        ...
                                        <select id="tipe_mutasi" name="tipe" class="form-control rounded-0<?php echo (!empty($psnGagal['tipe']) ? ' is-invalid' : '') ?>">
                                    ...
                                    <div class="form-group <?php echo (!empty($psnGagal['pelanggan']) ? 'text-danger' : '') ?>">
                                        ...
                                        <?php echo form_textarea(['id' => 'ket', 'name' => 'keterangan', 'class' => 'form-control rounded-0', 'placeholder' => 'Inputkan catatan / keterangan ...']) ?>
                                    </div>
                                </div>
                            </div>
                        </div>
