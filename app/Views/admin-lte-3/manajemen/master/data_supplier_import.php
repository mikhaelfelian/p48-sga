<div class="content-wrapper">
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-5">
                    <?php echo form_open_multipart(base_url('master/set_supplier_upload.php')); ?>
                        ...
                        <div class="card-footer">
                            <div class="row">
                                ...
                                <div class="col-lg-4 text-right">
                                    <button type="button" class="btn btn-success btn-flat" onclick="window.location.href = '<?php echo base_url('master/xls_supplier.php?status_temp=1') ?>'"><i class="fa fa-file-excel"></i> Template</button>
                                </div>
                                <div class="col-lg-4 text-right">
