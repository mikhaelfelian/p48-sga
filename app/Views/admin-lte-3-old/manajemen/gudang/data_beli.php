                                        ...
                                        foreach ($SQLBeli as $det) {
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 150px;">
                                                    <?php
                                                    if ($det->status_penerimaan == 3) {
                                                        echo anchor(base_url('gudang/penerimaan/data_beli_terima.php?id=' . $det->id), $det->no_nota, 'class="text-default"') . br();
                                                    } else {
                                                        echo $det->no_nota . br();
                                                    }
                                                    ?>
                                                ...
                                                <td style="width: 150px;">
                                                    <?php
                                                    if ($det->status_penerimaan == 3) {
                                                        echo status_penerimaan($det->status_penerimaan);
                                                    } else {
                                                        echo anchor(base_url('gudang/penerimaan/data_beli_terima.php?id=' . $det->id), '<i class="fa fa-check"></i> Terima', 'class="btn btn-primary btn-flat btn-xs" style="width: 65px;"');
                                                    }
                                                    ?>                                                
                                                    &nbsp;
                                                </td>
