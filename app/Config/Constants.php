...
$base = 'http' . ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] == 'on') ? 's' : 's') . '://' . $_SERVER['SERVER_NAME'] . "" . str_replace("index.php","", $_SERVER['SCRIPT_NAME']);
/*
 | --------------------------------------------------------------------
 | App Base URI Dinamis
 | --------------------------------------------------------------------
 |
 | Catatan penggunaan dinamis base uri
 */
