                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php if (!empty($row->file_name)): ?>
                                                            ...
                                                            $isPdf = (isset($row->file_ext) && strtolower($row->file_ext) === 'pdf') || 
                                                                    (isset($row->file_type) && $row->file_type === 'application/pdf');
                                                            
                                                            if ($isPdf): ?>
                                                                <a href="<?= base_url($row->file_name) ?>"
                                                                   target="_blank"
                                                            ...
                                                            <?php else: ?>
                                                                <a href="<?= base_url($row->file_name) ?>"
                                                                   ...
                                                                   data-title="Dokumen Pendidikan - <?= $row->pendidikan ?>"
        ...
        $(document).on('click', '[data-toggle="lightbox"]', function (event) {
            ...
            $(this).ekkoLightbox({
                ...
                onHide: function () {
                    ...
                    setTimeout(function () {
                        $('[data-toggle="lightbox"][aria-expanded="true"]').focus();
                    }, 300);
                }
            });
        });
