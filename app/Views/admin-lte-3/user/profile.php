                ...
                <div class="col-md-3">
                    <div class="card card-primary card-outline">
                        <div class="card-body box-profile">
                            ...
                            <h3 class="profile-username text-center"><?php echo strtoupper($Pengguna->first_name) ?></h3>
                            <p class="text-muted text-center"><?php echo ucwords($PenggunaGrup->name) ?></p>
                            <ul class="list-group list-group-unbordered mb-3">
                                <li class="list-group-item">
                                    <b>Nama Lengkap</b> <a class="float-right"><?php echo strtoupper($Pengguna->first_name) ?></a>
                                </li>
                                <li class="list-group-item">
                                    <b>Username</b> <a class="float-right"><?php echo strtolower($Pengguna->username) ?></a>
                                </li>
                            </ul>
                        </div>
                    </div>
