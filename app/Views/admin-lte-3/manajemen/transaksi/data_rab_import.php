<div class="content-wrapper">
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-5">
                    <?php echo form_open_multipart(base_url('transaksi/rab/set_trans_import.php')); ?>
                    <div class="card card-default">
                        ...
                        <div class="card-footer">
                            <div class="row">
                                <div class="col-lg-4">
                                    <button type="button" onclick="window.location.href = '<?php echo base_url('transaksi/rab/data_rab.php') ?>'" class="btn btn-primary btn-flat">&laquo; Kembali</button>
                                </div>
                                <div class="col-lg-4 text-right">
                                    <button type="button" class="btn btn-success btn-flat" onclick="window.location.href = '<?php echo base_url('transaksi/rab/xls_rab_import.php') ?>'"><i class="fa fa-file-excel"></i> Template</button>
                                </div>
                                <div class="col-lg-4 text-right">
