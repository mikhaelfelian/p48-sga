<div class="content-wrapper">
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-4">
                    <?php echo form_open(base_url('master/set_berkas_simpan.php')); ?>
                    <div class="card card-default">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group <?php echo (!empty($psnGagal['tipe']) ? 'has-error' : '') ?>">
                                ...
                                <?php echo form_input(['id' => 'tipe', 'name' => 'tipe', 'class' => 'form-control rounded-0' . (!empty($psnGagal['kategori']) ? ' is-invalid' : ''), 'placeholder' => 'Isikan kategori ...', 'value' => (!empty($SQLKategori->kategori) ? $SQLKategori->kategori : '')]) ?>
                            </div>
