                                                ...
                                                <div class="form-group row<?php echo (!empty($psnGagal['harga']) ? ' text-danger' : '') ?>">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <?php echo form_input(['id' => 'harga', 'name' => 'harga', 'class' => 'form-control rounded-0 pull-right' . (!empty($psnGagal['harga']) ? ' is-invalid' : ''), 'placeholder' => 'Isikan Biaya ...', 'value' => (!empty($SQLRabDetRw) ? $SQLRabDetRw->harga : '')]) ?>
                                                        </div>
                                                    </div>
                                                </div>
