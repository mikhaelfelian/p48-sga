                ...
                <div class="col-md-12">
                    <div class="card card-default">
                        ...
                        <?php
                                ...
                                $uri_xls    = base_url('master/xls_'.$uri.'.php?'.(!empty($kode) ? 'filter_kode='.$kode.'&' : '').(!empty($kat) ? 'filter_kat='.$kat : ''));
                            ?>
                            <button class="btn btn-success btn-flat" onclick="window.location.href = '<?php echo $uri_xls ?>'"><i class="fas fa-file-excel"></i> Data Kategori</button>
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    <?php echo form_open(base_url('master/set_kategori_cari.php')) ?>
                                    <tr>
                                        ...
                                        <th>
                                            <?php echo form_input(['id' => 'kategori', 'name' => 'kategori', 'class' => 'form-control input-sm rounded-0', 'placeholder' => 'Isikan keterangan ...']) ?>
                                        </th>
                                        <th>
                                    ...
                                    <?php echo form_close(); ?>
                                    <?php
                                    if (!empty($SQLKategori)) {
                                        $no = $Halaman;
                                        foreach ($SQLKategori as $kategori) {
                                            ?>
                                            <tr>
