                ...
                <div class="col-lg-8">
                    <?php 
                        if(isset($_GET['act'])){
                            switch($_GET['act']){                                    
                                case 'po_input':
                                    echo view($ThemePath.'/manajemen/transaksi/data_rab_po_input');
                                    break;
                                
                                case 'po_input_item':
                                    echo view($ThemePath.'/manajemen/transaksi/data_rab_po_input_item');
                                    break;
                            }
                        }else{
                            echo view($ThemePath.'/manajemen/transaksi/data_rab_po_surat');
                        }
                    ?>
                </div>
                <div class="col-lg-4">
