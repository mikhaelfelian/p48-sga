        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <?php echo form_open(base_url('transaksi/rab/set_trans_simpan.php'), 'autocomplete="off"') ?>
                        ...
                        <div class="card-body table-responsive">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group <?php echo (!empty($psnGagal['pelanggan']) ? 'text-danger' : '') ?>">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <div class="input-group-append">
                                                <span class="input-group-text rounded-0"><?php echo anchor(base_url('master/data_pelanggan_tambah.php?route=transaksi/rab/data_rab_tambah.php'), '<i class="fas fa-plus"></i>') ?></span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group<?php echo (!empty($psnGagal['no_paket']) ? 'text-danger' : '') ?>">
                                        <label for="inputEmail3" class="control-label">No. Paket</label>
                                        <?php echo form_input(['id' => 'no_paket', 'name' => 'no_paket', 'class' => 'form-control rounded-0 text-left' . (!empty($psnGagal['no_paket']) ? ' is-invalid' : ''), 'style' => 'vertical-align: middle;', 'placeholder' => 'Isikan No Paket ...']) ?>
                                    </div>
                                    <div class="form-group<?php echo (!empty($psnGagal['hps']) ? 'text-danger' : '') ?>">
                                        <label for="inputEmail3" class="control-label">HPS</label>
                                        <div class="input-group mb-3">
                                            <div class="input-group-append">
                                                <span class="input-group-text">Rp. </span>
                                            </div>
                                            <?php echo form_input(['id' => 'hps', 'name' => 'hps', 'class' => 'form-control rounded-0 text-left' . (!empty($psnGagal['hps']) ? ' is-invalid' : ''), 'style' => 'vertical-align: middle;', 'placeholder' => 'Isikan Harga Pokok Sementara ...']) ?>
                                        </div>
                                    </div>
                                    -->
                                    <div class="form-group<?php echo (!empty($psnGagal['pagu']) ? 'text-danger' : '') ?>">
                                        <label for="inputEmail3" class="control-label">Harga Penawaran / Pagu</label>
                                        <div class="input-group mb-3">
                                            <div class="input-group-append">
                                                <span class="input-group-text">Rp. </span>
                                            </div>
                                            <?php echo form_input(['id' => 'pagu', 'name' => 'pagu', 'class' => 'form-control rounded-0 text-left' . (!empty($psnGagal['id_sales']) ? ' is-invalid' : ''), 'style' => 'vertical-align: middle;', 'placeholder' => 'Isikan Pagu ...']) ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
