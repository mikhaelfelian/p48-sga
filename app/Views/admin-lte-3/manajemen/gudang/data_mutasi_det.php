                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-footer">
                                <div class="row">
                                    <div class="col-md-6">                                        
                                        <button type="button" class="btn btn-primary btn-flat" onclick="window.location.href='<?php echo base_url('gudang/mutasi/data_mutasi.php'); ?>'"><i class="fas fa-arrow-left"></i> Kembali</button>
                                    </div>
